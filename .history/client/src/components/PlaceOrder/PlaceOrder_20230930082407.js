...
function PlaceOrder() {
  ...
  const totalPrice1 = useSelector((state) => state.totalPrice);
  return (
            ...
            <div className={styles.orderDetails}>
              <div className={styles.shippingDetails}>
                ...
                <div style={{textAlign:'start', paddingLeft:'1rem',}}>
                  <span style={{fontSize:'medium', color:'#B52B00', fontWeight:'500'}}>Order Total: ₹{totalPrice1.setTotalPrice}</span><br />
              ...
              <div className={styles.pricingDetails}>
                <div className={styles.priceWrapper}>
                  <button className={styles.placeYourOrder} onClick={()=>{navigate('/success')}} >Place order</button>
                  <span style={{fontSize:'small', fontWeight:'500'}}>By placing your order, you agree to Musicart privacy notice and conditions of use.</span>
