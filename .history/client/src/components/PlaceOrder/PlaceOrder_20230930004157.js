                  ...
                  <div style={{maxWidth:'40%', flexWrap:'wrap', textAlign:'start',fontSize:'large', fontWeight:'500', marginTop:'0'}}>
                    {
                      cartItems&&cartItems.map((item, idx)=>(
                        <div className={styles.itemCard} key={idx}>
                          ...
                          <span style={{fontSize:'medium', fontWeight:'500', marginTop:'0.4rem', color:'#797979'}}>Color : {item.color}</span>
                          <span style={{fontSize:'medium', fontWeight:'500', marginTop:'0.4rem', color:'#797979'}}>{item.isAvailable?'In Stock':'Out of stock'}</span>
                        </div>
                      ))
                    }
                  </div>
