          ...
          <div style={{width:'100%', display:'flex', justifyContent:'center', marginTop:'2rem', marginBottom:'4rem'}}>
            ...
            <div className={styles.orderDetails}>
              <div className={styles.shippingDetails}>
                ...
                <button className={styles.placeYourOrderSmall} onClick={()=>{navigate('/place-order')}} >Place order</button>
                <div style={{textAlign:'start', paddingLeft:'1rem',}}>
                  <span style={{fontSize:'medium', color:'#B52B00', fontWeight:'500'}}>Order Total:</span><br />
              ...
              <div className={styles.pricingDetails}>
                <div className={styles.priceWrapper}>
                  ...
                  <h2 style={{fontWeight:'500', marginTop:'0', textAlign:'start', width:'80%'}}>Order Summary</h2>
                  <span style={{width:'80%', display:'flex', justifyContent:'space-between'}}></span>
                </div>
              </div>
            </div>
