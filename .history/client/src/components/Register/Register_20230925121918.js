      ...
      <form className={styles.form}>
        ...
        <div className={styles.inputContainer}>
          ...
          <div style={DivStyles}>
            ...
            <input type="email" name="email" value={user.email} onChange={handleChange} placeholder="Email" style={InputStyles}/>
          </div>

          <div style={DivStyles}>
            <label htmlFor="mobile">Mobile</label>
            <input type="text" name="mobile" value={user.mobile} onChange={handleChange} placeholder="Mobile" style={InputStyles} />
          </div>

          <div style={DivStyles}>
            <label htmlFor="password">Password</label>
            <input type="password" name="password" value={user.password} onChange={handleChange} placeholder="Password" style={InputStyles} />
          </div>
        </div>
