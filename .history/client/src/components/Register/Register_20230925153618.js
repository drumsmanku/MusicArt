  ...
  return (
    <div className={styles.container}>
      <div className={styles.heading}>
        <img src={img1}alt="" height={40} style={{marginTop:'1rem', marginBottom:'1rem'}} />
      </div>
      ...
      <footer style={{position:'absolute', bottom:0, backgroundColor:'#2E0052', width:'100%', padding:'0.6rem 0 0.6rem 0', color:'white'}}>
