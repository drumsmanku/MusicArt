    ...
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <div className={styles.inputContainer}>
          <h2 style={{alignSelf:'start', paddingLeft:'2.8rem', fontWeight:600}}>Create Account</h2>
          <div style={DivStyles}>
        ...
        <div style={{width:'100%'}}>
          <span style={{width:'80%', textAlign:'left', fontWeight:600}}>By enrolling your mobile phone number, you consent to receive automated security notifications via text message from Musicart. Message and data rates may apply.
          </span>
