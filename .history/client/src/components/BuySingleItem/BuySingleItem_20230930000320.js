          ...
          <div className={styles.cartItems}>
            ...
            <div className={styles.cartItemsFinalPrice}>
              ...
              <div className={styles.finalPriceDiv}>
                ...
                <span style={{display:'flex', width:'80%', justifyContent:'space-between', marginTop:'10rem'}}><h2 style={{fontWeight:'500'}}>Total Amount</h2><h3 style={{fontWeight:'500'}}>₹₹{buyItems.price+45}</h3></span>
