          ...
          <div className={styles.cartItems}>
              ...
              <hr style={{width:'100%', border:'2.87px solid #E1E1E1',}} />
                      ...
                      <div className={styles.details} >
                        ...
                        <div style={{display:'flex', flexDirection:'column', width:'20%', textAlign:'start', fontWeight:'500', paddingLeft:'3rem'}}>
                          ...
                          <span style={{marginBottom:'0.7rem'}}>₹</span>
            ...
            <div className={styles.cartItemsFinalPrice}>
              ...
              <div className={styles.finalPriceDiv}>
                ...
                <span style={{display:'flex', width:'80%', justifyContent:'space-between'}}><h3 style={{fontWeight:'500'}}>Total MRP</h3><h3 style={{fontWeight:'500'}}>₹</h3></span>
                ...
                <span style={{display:'flex', width:'80%', justifyContent:'space-between', marginTop:'10rem'}}><h2 style={{fontWeight:'500'}}>Total Amount</h2><h3 style={{fontWeight:'500'}}>₹</h3></span>
                <button className={styles.placeYourOrder} >Place order</button>
              </div>
            </div>
          </div>
        </div>
