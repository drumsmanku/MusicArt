          ...
          <div className={styles.cartItems}>
            ...
            <div className={styles.cartItemsFinalPrice}>
              ...
              <div className={styles.finalPriceDiv}>
                ...
                <button className={styles.placeYourOrder} disabled={!buyItems.length} onClick={()=>{navigate('/single-item-place-order', { state: { totalPrice: buyItems.price*parseInt(quantities) } })}} >Place order</button>
              </div>
            </div>
          </div>
        </div>
