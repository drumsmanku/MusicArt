  ...
  return (
    <div className={styles.container}>
      <div className={styles.heading}>
        <img src={img1}alt="" height={40} style={{marginTop:'2rem', marginBottom:'2rem'}} />
      </div>
      ...
      <div style={{display:'flex', marginTop:'2.5rem'}}>
        ...
        <span style={{margin:'0 1.5rem 0 1.5rem'}}>New to Musicart?</span>
        <hr style={{ height:'2px', width:'9rem', backgroundColor:'#BDBDBD', border:'none'}}/>
      </div>

      <button className={styles.notLoggedInButton} style={{background:'none', color:'#36416A', fontSize:'medium', marginLeft:0, padding:0, width:'4rem', cursor:'pointer', border:'none', textDecoration:'underline'}} onClick={()=>{navigate('/login')}}>Sign in</button>
