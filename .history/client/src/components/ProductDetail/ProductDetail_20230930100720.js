                ...
                <div className={styles.otherDetails}>
                  <div className={styles.imagesDiv}>
                    ...
                    <div className={styles.otherViewImages}>
                      <div style={{border:'4px solid #2E0052', paddingTop:'3rem', paddingBottom:'2rem', width:'30%', borderRadius:'1rem'}}>
                        <img  src={productDet.imageURLs ? productDet.imageURLs[0] : 'default-image-url'} alt="" height={130} width='35%'/>
                      </div>
                    </div>
                  </div>
