                  ...
                  <div className={styles.imagesDiv}>
                    ...
                    <div className={styles.otherViewImages}>
                      <div style={{border:'4px solid #2E0052', paddingTop:'1rem', paddingBottom:'1rem', width:'23%', borderRadius:'1rem', marginRight:'1rem', marginTop:'1rem'}}>
                        <img  src={productDet.imageURLs ? productDet.imageURLs[0] : 'default-image-url'} alt="" height={130} width='42%'/>
                      </div>
                      <div style={{border:'4px solid #2E0052', paddingTop:'1rem', paddingBottom:'1rem', width:'23%', borderRadius:'1rem', marginRight:'1rem', marginTop:'1rem'}}>
                        <img  src={productDet.imageURLs ? productDet.imageURLs[1] : 'default-image-url'} alt="" height={130} width='42%'/>
                      </div>
                    </div>
                  </div>
