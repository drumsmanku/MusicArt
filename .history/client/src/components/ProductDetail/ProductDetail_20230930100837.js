                ...
                <div className={styles.otherDetails}>
                  <div className={styles.imagesDiv}>
                    ...
                    <div className={styles.otherViewImages}>
                      <div style={{border:'4px solid #2E0052', paddingTop:'2rem', paddingBottom:'2rem', width:'25%', borderRadius:'1rem', marginRight:'1rem', marginTop:'1rem'}}>
                        <img  src={productDet.imageURLs ? productDet.imageURLs[0] : 'default-image-url'} alt="" height={140} width='42%'/>
                      </div>
                    </div>
                  </div>
