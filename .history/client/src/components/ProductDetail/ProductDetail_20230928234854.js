              ...
              <div className={styles.productInfo}>
                ...
                <div className={styles.otherDetails}>
                  ...
                  <div className={styles.otherDetailsDiv}>
                    ...
                    <span><h2 style={{ fontWeight:'500', marginTop:0}}>Available-</h2>{productDet.isAvailable? <h2 style={{ marginTop:0, fontWeight:'400'}}>In stock </h2>: <h2 style={{ marginTop:0, fontWeight:'400'}}>Not in stock</h2>}</span>
