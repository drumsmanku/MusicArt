              ...
              <div className={styles.productInfo}>
                ...
                <div className={styles.otherDetails}>
                  ...
                  <div className={styles.otherDetailsDiv}>
                    ...
                    <span><b style={{fontSize:'large', fontWeight:'500'}}>Available-</b>{productDet.isAvailable? <h2 style={{ marginTop:0, fontWeight:'400'}}>In stock </h2>: <h2 style={{ marginTop:0, fontWeight:'400'}}>Not in stock</h2>}</span>
