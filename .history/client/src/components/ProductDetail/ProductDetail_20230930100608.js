                ...
                <div className={styles.otherDetails}>
                  <div className={styles.imagesDiv}>
                    ...
                    <div className={styles.otherViewImages}>
                      <div style={{border:'4px solid #2E0052', paddingTop:'5rem', paddingBottom:'4rem', width:'30%', borderRadius:'1rem'}}>
                        <img  src={productDet.imageURLs ? productDet.imageURLs[0] : 'default-image-url'} alt="" height={400} width='100%'/>
                      </div>
                    </div>
                  </div>
