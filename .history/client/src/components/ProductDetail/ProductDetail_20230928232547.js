...
function ProductDetail() {
  ...
  useEffect(()=>{
    axios.get(`http://localhost:4000/get-prod-desc/${id}`)
         .then(res=>{setProductDet(res.data.product); detailed_description=productDet.detailed_desc;lines = detailed_description.split('\n');})
                ...
                <div className={styles.otherDetails}>
                  <div className={styles.imagesDiv}>
                    <div style={{border:'4px solid #2E0052', paddingTop:'5rem', paddingBottom:'4rem', width:'80%', borderRadius:'1rem'}}>
                      <img  src={productDet.imageURLs[0]} alt="" height={400}width='45%'/>
                    </div>
