...
function Cart() {
  ...
  const handleQuantityChange = (e, id) => {
    const value = parseInt(e.target.value);  // value is parsed to an integer
          ...
          <div className={styles.cartItems}>
            ...
            <div className={styles.cartItemsFinalPrice}>
              ...
              <div className={styles.finalPriceDiv}>
                ...
                <span style={{display:'flex', width:'80%', justifyContent:'space-between'}}><h2 style={{fontWeight:'500'}}>Total Amount</h2><h3 style={{fontWeight:'500'}}>₹{calculateTotalPrice()+45}</h3></span>
              </div>
            </div>
          </div>
        </div>
