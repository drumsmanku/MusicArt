                  ...
                  cartItems.length > 0?(
                    cartItems.map((item, idx)=>(
                      <div className={styles.details} key={idx}>
                        ...
                        <div style={{display:'flex', flexDirection:'column', width:'15%', textAlign:'start', fontWeight:'500'}}>
                        ...
                        <div style={{display:'flex', flexDirection:'column', width:'10%', textAlign:'start', fontWeight:'500'}}>
                          ...
                          <select className={styles.quantity} value={quantity} onChange={(e) => setQuantity(e.target.value)}>
                        ...
                        <div style={{display:'flex', flexDirection:'column', width:'20%', textAlign:'start', fontWeight:'500', paddingLeft:'2rem'}}>
                          <h3 style={{fontWeight:'600', marginTop:'0.3rem', marginBottom:'1rem'}}>Total</h3>
                          <span style={{marginBottom:'0.7rem'}}>₹{item.price * quantity}</span>
