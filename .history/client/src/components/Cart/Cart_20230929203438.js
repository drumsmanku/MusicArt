                  ...
                  cartItems.length > 0?(
                    cartItems.map((item, idx)=>(
                      <div className={styles.details} key={idx}>
                        ...
                        <div style={{display:'flex', flexDirection:'column', marginLeft:'1rem', width:'20%', textAlign:'start', fontWeight:'500'}}>
                          <h3 style={{fontWeight:'600', marginTop:'0'}}>{item.name_of_product}</h3>
                          <span style={{marginBottom:'1rem'}}>Color:{item.color}</span>
