...
function MainPage() {
  ...
  const [companyOption, setCompanyOption] = useState('Company');
  ...
  const fetchProducts = async () => {
    ...
    route += '?type=' + typeOption + '&company=' + companyOption + '&color=' + colorOption + '&price=' + priceOption + '&sort=' + sortingOption;
