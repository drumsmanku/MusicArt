              ...
              <div className={styles.productsInGrid}>
                {
                  products&&products.map((product, idx)=>(
                    <div className={styles.cardStylesInGrid} key={idx}>
                      ...
                      <span  style={{backgroundColor:'white', borderRadius:'50%', height:'2rem', width:'2rem', boxShadow:'0 0 7px 0 #00000040', display:'flex', alignItems:'center', justifyContent:'center', }}>
