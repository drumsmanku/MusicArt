    ...
    <div className={styles.container}>
      ...
      <div className={styles.mainBody}>
        <div className={styles.bodyContent}>
          ...
          <div style={{backgroundImage:`url(${gradient})`, backgroundRepeat:'no-repeat', backgroundPosition:'center', backgroundSize:'100%', height:'20rem', paddingLeft:'5rem'}}>
            <div style={{display:'flex', flexDirection:'column', alignItems:'flex-start'}}>
              <h1 style={{color:'#2E0052', width:'40%', textAlign:'start', fontWeight:'bolder'}}>Grab upto 50% off on Selected headphones</h1>
