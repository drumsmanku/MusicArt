    ...
    <div className={styles.container}>
      ...
      <div className={styles.mainBody}>
        <div className={styles.bodyContent}>
          ...
          <div style={{backgroundImage:`url(${gradient})`, backgroundRepeat:'no-repeat', backgroundPosition:'center', backgroundSize:'100%', height:'20rem'}}>
            <div style={{display:'flex', flexDirection:'column', alignItems:'flex-start',fontWeight:'bolder'}}>
              <h1 style={{color:'#2E0052', width:'40%', textAlign:'start', }}>Grab upto 50% off on Selected headphones</h1>
            </div>
          </div>
        </div>
      </div>
