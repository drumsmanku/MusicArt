...
function MainPage() {
  ...
  const [typeOption, setTypeOption] = useState('Headphone type');
        ...
        <div className={styles.bodyContent}>
          ...
          <div className={styles.sortAndFilter}>
            ...
            <div className={styles.filters}>
               <select className='select' style={{border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'medium', fontWeight:'bold'}} value={typeOption} onChange={(e) => setTypeOption(e.target.value)}>
