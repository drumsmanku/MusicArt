                  ...
                  products&&products.map((product, idx)=>(
                    <div className={styles.cardStylesInList} key={idx}>
                      <div style={{ position: "relative", height:'100%', width:'30%', marginBottom:'0.5rem' }}>
                        ...
                        <span onClick={()=>{handleAddToCart(product)}} style={{
                          position: 'absolute', backgroundColor: 'white', borderRadius: '50%', height: '2rem', width:'2rem', boxShadow: '0 0 7px 0 #00000040', display:'flex',alignItems:'center', justifyContent:'center', zIndex:'999', right: '3rem', bottom: '5%'}}>
                          <img src={cartImg} alt="" height={20} />
                        </span>
                      </div>
