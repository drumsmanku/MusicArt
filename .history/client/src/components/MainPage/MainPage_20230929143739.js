                  ...
                  products&&products.map((product, idx)=>(
                    <div className={styles.cardStylesInGrid} key={idx}>
                      <div className={styles.imgStylesGrid} onClick={()=>{navigate(`/get-prod-det/${product._id}`)}}>
                        ...
                        <span  style={{backgroundColor:'white', borderRadius:'50%', height:'2rem', width:'2rem', boxShadow:'0 0 7px 0 #00000040', display:'flex', alignItems:'center', justifyContent:'center', zIndex:'999', position:'relative', right:0, bottom:0}}>
